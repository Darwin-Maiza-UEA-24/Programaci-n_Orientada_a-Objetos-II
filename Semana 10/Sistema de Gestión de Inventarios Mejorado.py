...
class Producto:
    ...
    def __str__(self):
        return f"{self.id},{self.nombre},{self.tipo},{self.plataforma},{self.cantidad},{self.precio}"
    ...
    def cargar_inventario(self):
        ...
        try:
            with open(self.archivo, "r") as file:
                for linea in file:
                    id, nombre, tipo, plataforma, cantidad, precio = linea.strip().split(",")
                    productos.append(Producto(int(id), nombre, tipo, plataforma, int(cantidad), float(precio)))
